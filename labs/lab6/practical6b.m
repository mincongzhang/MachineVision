...
for (cSample = 1:nSample)
        ...
        newPosition(1) = gaussMeanXGivenY + randn(1)*gaussVarXGivenY;
        ...
        %Gaussian distribution. Replace this:
        gaussMeanYGivenX = gaussMean(2) + gaussCov(1,2)*gaussCov(1,1)^(-1)*(position(1) - gaussMean(1));
        gaussVarYGivenX = gaussCov(2,2) - gaussCov(1,2)*gaussCov(1,1)^(-1)*gaussCov(1,2);
